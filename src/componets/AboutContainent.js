...
function about() {
  return (
    <>
      <div data-aos="fade-right" className="card mb-3 my-3 m-auto " style={{ maxWidth: '85%', alignItems: 'center', backgroundColor: '#d9d9d9' }}>
      ...
      <div data-aos="fade-left" className="card mb-3 my-3 m-auto" style={{ maxWidth: '85%', backgroundColor: '#d9d9d9' }}>
        <div className="row g-0">
          <div className="col-md-4">
      ...
      <div class="row">
        <div id='link' class="col align-self-center my-4">
          <a rel="noreferrer" href="https://en.wikipedia.org/wiki/Shivaji" target="_blank">For More Information click here</a>
        </div>
      </div>
      </div>
